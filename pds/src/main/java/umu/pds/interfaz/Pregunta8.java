...
public class Pregunta8 extends JFrame {
	...
	public Pregunta8() {
		...
		*/
        ...
        JLabel lblFrase = new JLabel("¿Cuántas eurocopas ha ganado la selección española de futbol?");
        ...
        JButton opcion1 = new JButton("1. 3");
        JButton opcion2 = new JButton("2. 4");
        JButton opcion3 = new JButton("3. 5");
