...
public class Pregunta11 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pregunta11 frame = new Pregunta11();
	...
	public Pregunta11() {
		...
		*/
        ...
        // Pregunta en negrita
        JLabel lblPregunta = new JLabel("Responde a la siguiente pregunta : ");
        lblPregunta.setFont(new Font("Arial", Font.BOLD, 16));
        lblPregunta.setForeground(Color.BLACK);

        // Frase con hueco para completar
        JLabel lblFrase = new JLabel("¿Cuáles de estos jugadores no ha ganado un balón de oro?");
        ...
        JButton opcion1 = new JButton("1. Luka Modric");
        JButton opcion2 = new JButton("2. Karim Benzema");
        JButton opcion3 = new JButton("3. Dani Carvajal");
