...
public class Pregunta7 extends JFrame {
	...
	public Pregunta7() {
		...
		*/
        ...
        // Pregunta en negrita
        JLabel lblPregunta = new JLabel("Completa la frase de Josep Mourinho : ");
        lblPregunta.setFont(new Font("Arial", Font.BOLD, 16));
        lblPregunta.setForeground(Color.BLACK);

        // Frase con hueco para completar
        JLabel lblFrase = new JLabel("Si te gusta la presión, estás en el club adecuado. Si no, vete _____");
        ...
        JButton opcion1 = new JButton("1. a tomar viento");
        JButton opcion2 = new JButton("2. al banquillo");
        JButton opcion3 = new JButton("3. al circo");
