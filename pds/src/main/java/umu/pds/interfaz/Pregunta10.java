...
public class Pregunta10 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pregunta10 frame = new Pregunta10();
	...
	public Pregunta10() {
		...
		*/
        ...
        // Pregunta en negrita
        JLabel lblPregunta = new JLabel("Completa la frase de Vicente del Bosque :");
        lblPregunta.setFont(new Font("Arial", Font.BOLD, 16));
        lblPregunta.setForeground(Color.BLACK);

        // Frase con hueco para completar
        JLabel lblFrase = new JLabel("En el fútbol no siempre ganan los mejores, sino los que mejor _____");
        ...
        JButton opcion1 = new JButton("1. compiten");
        JButton opcion2 = new JButton("2. pierden");
        JButton opcion3 = new JButton("3. ganan");
