...
public class Pregunta2 extends JFrame {
	...
	public Pregunta2() {
		...
		*/
        ...
        JLabel lblFrase = new JLabel("¿Cuántas champions league tiene el real madrid?");
        ...
        JButton opcion1 = new JButton("1. 15");
        JButton opcion2 = new JButton("2. 14");
        JButton opcion3 = new JButton("3. 13");
