...
public class CursoTest extends TestCase {
	...
	static String[] estrategiasBase = { "Secuencial", "RepeticionEspaciada" };
	static String[] estrategias = { "Secuencial", "Aleatoria", "RepeticionEspaciada" };
